...
[FREE DEMO](https://demo.essentialplugin.com/timeline-and-history-slider-demo/?utm_source=WP&utm_medium=Timeline&utm_campaign=Read-Me) | [PRO DEMO](https://demo.essentialplugin.com/prodemo/timeline-and-history-slider-pro/?utm_source=WP&utm_medium=Timeline&utm_campaign=Read-Me)
...
<code>[th-slider limit="4"]</code>
Where limit define the number of posts to display.

**If you want to display Slider by category then use this short code:** 

<code>[th-slider category="category_ID"]</code>
Enter category id to display categories wise.

**Complete shortcode example:**

<code>[th-slider design="design-1" slidestoshow="3" category="8" centermode="false" dots="true" arrows="true" autoplay="true"  autoplay_interval="5000" speed="1000"]</code>
...
[Annual or Lifetime Bundle Deal](https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=Timeline&utm_campaign=Read-Me)
...
= How to install : =
[youtube https://www.youtube.com/watch?v=1PtzRqyoYjQ]
...
[*] Update – Update opt-in screen.
[*] Update – Update slick jQuery 1.8.0.
[*] Fix – Fixed typo mistake in Gutenberg.
...
= 1.4.3 (22, April 2021) =
* [*] Fixed Fusion page builder tab and toggle issue.
* [*] Tested up to: 5.7.
...
= 1.3.4 (28, April 2020) =
* [+] Added 'slidestoshow' shortcode parameter for [th-slider] to set display number of images at a time.
* [+] Added 'centermode' shortcode parameter for [th-slider] to control centermode without depending on post count.
* [*] Minor change in shortcode file structure.
* [*] Tweak - Code optimization and performance improvements.
...
= 1.2.4 (11 Dec, 2017) =
* Fixed issue with RTL website.

= 1.2.3 (04 Dec, 2017) =
* Fixed issue with timeline navigation.

= 1.2.2 (7-9-2017) =
* Fixed js include issue
* Fixed some css bug

= 1.1.5 (14-7-2017) =
* Fixed WPML plugin issue with category

= 1.1.4 (28-6-2017) =
* Tested up to WP 4.8
* Fixed image issue showing ALT tag if image not added
...
= 1.1.1 =
* [+] Added "How it work" menu tab
* Fixed some js and css bug

= 1.1 =
* Added a new design
* Fixed some js and css bug
* Added design parameter
